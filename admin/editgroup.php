...
<div class="modal-content" id="modal-content">
    <form action="assets/includes/adminprocess.php" id="user-groups-edit" class="form-horizontal" method="post">
                        ...
                        <div class="panel-body">
                            ...
                            while ($row = $result->fetch()) {
                                ...
                                if ($row['username'] != ADMIN_NAME) {
                                    echo "<a href='assets/includes/adminprocess.php?remove=" . $row['id'] . "&group_id=" . $row['group_id'] . "&stop=" . $stop . "&form_submission=remove_groupmember' title='Remove Group Member' class='btn btn-danger confirmation_deleteuser'>";
