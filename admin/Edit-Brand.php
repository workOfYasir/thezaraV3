...
<h4><strong>Brand Image</strong> - Edit Brand Image </h4>
</div>
</div>
</div>                                     
</div>
...
<div class="row">                    
	<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="panel">
			...
			<h2 class="panel-title">Edit Brand Image</h2>
			</div>
			<div class="panel-body">
				<form method="post" enctype="multipart/form-data" action="updateaction/update_brand.php">
					<fieldset>
						...
						<div class="col-md-4">
						<a href="javascript: void(0)" onclick="popup('../images/Brand/<?php echo $row22['slide_image'];?>')"><img src="../images/Brand/<?php echo $row22['silde_image'];?>" width="250" height="200" /></a>
						</div> 
						</div>
					</fieldset>
