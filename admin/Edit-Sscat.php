...
$result22 = mysqli_query($servercnx, "SELECT * FROM sscat WHERE id = '$id'");
$row22 = mysqli_fetch_array($result22);
$id = $row22['id'];
$sscat_uniid = $row22['sscat_uniid'];
$sscat_mcate = $row22['sscat_mcate'];
$result234 = mysqli_query($servercnx, "SELECT mcat_title FROM mcat WHERE mcat_uniid = '$sscat_mcate'");
		...
		<div class="col-sm-12 col-md-12">
			<div class="panel">
				<div class="panel-body">
					<h4><strong>Page Categories</strong> - Edit Level III </h4>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="panel">
				...
				<div class="panel-body">
					<form method="post" enctype="multipart/form-data" action="updateaction/update_sscat.php">
						<fieldset>
							...
							<div class="form-group row"><label class="col-md-12 col-form-label">Parent Category:</label>
								...
								<div class="col-md-12">
									<select class="form-control" name="sscat_scate" id="sscat_scate" required>
										...
										<?php
										include("assets/includes/inc/config.php");
										$mainpageap = mysqli_query($servercnx, "SELECT * FROM scat WHERE scat_cates = 'Yes' AND scat_status = 'Active' ORDER BY scat_title ASC");
