...
$result22 = mysqli_query($servercnx, "SELECT * FROM scat WHERE id = '$id'");
$row22 = mysqli_fetch_array($result22);
$id = $row22['id'];
$scat_uniid = $row22['scat_uniid'];
$result233 = mysqli_query($servercnx, "SELECT COUNT(id) AS sscate_count FROM sscat WHERE sscat_scate = '$scat_uniid'");
		...
		<div class="col-sm-12 col-md-12">
			<div class="panel">
				<div class="panel-body">
					<h4><strong>Page Categories</strong> - Edit Level I </h4>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="panel">
				...
				<div class="panel-body">
					<form method="post" enctype="multipart/form-data" action="updateaction/update_scat.php">
						<fieldset>
								...
								<div class="col-md-12">
									<select class="form-control" name="scat_mcate" id="scat_mcate" required>
										...
										while ($mainrowap = mysqli_fetch_array($mainpageap)) { ?>
											<option value="<?php echo $mainrowap['mcat_uniid']; ?>" <?php if ($mainrowap['mcat_uniid'] == $row22['scat_mcate']) {
																										echo "selected='selected'";
																									} ?>><?php echo $mainrowap['mcat_title']; ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
...
<!-- 
						...
						<!-- <fieldset><br>
							<div class="form-group row"> <label class="col-md-12 col-form-label" for="input-id-1">Category Feature Image (Min Size: 1920 x 1000)</label>
								...
								<div class="col-md-4">
									<a href="javascript: void(0)" onclick="popup('../images/Categories/Covers/<?php // echo $row22['scat_cover']; ?>')"><img src="../images/Categories/Covers/<?php // echo $row22['scat_cover']; ?>" width="50%" /></a>
								</div>
							</div>
						</fieldset> -->
