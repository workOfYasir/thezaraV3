		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="panel">
				...
				<div class="panel-body">
					...
					<table class="table table-bordered table-hover users-table table-responsive" id="data-table" width="100%">
						...
						ON pt.prayer_date_id = pd.pd_id WHERE prayer_date >= CURDATE() ");
