        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                <div class="panel-body">
                    <h4><strong>Blog Categories</strong> - Add Blog Category </h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form method="post" enctype="multipart/form-data" action="createaction/add_blog_mcat.php">
                        <fieldset>
                        ...
                        <fieldset>
                            <div class="form-group row col-md-12">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="mcat_url" id="mcat_url" type="text" placeholder="Enter Category URL">
                                </div>
                                <div class="col-md-2">
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" class="form-control" name="mcat_summary" id="mcat_summary" maxlength="25" title="Only Alphanumeric" value="Type Alphanumeric Only" onkeydown="return alphaOnly(event);"></textarea>
                                </div>
                            </div><br>
                        </fieldset>
                        <fieldset>
                            <div class="form-group row"><label class="col-md-12 col-form-label">Category Body:</label>
                                <div class="col-md-12"><textarea name="mcat_body" id="mcat_body" class="update_input ckeditor form-control" accept-charset="iso-8859-1"></textarea></div>
                            </div>
                        </fieldset>
