...
$result22 = mysqli_query($servercnx, "SELECT * FROM blog_mcat WHERE id = '$id'");
		...
		<div class="col-sm-12 col-md-12">
			<div class="panel">
				<div class="panel-body">
					<h4><strong>Blog Categories</strong> - Edit Blog Category</h4>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="panel">
				...
				<div class="panel-body">
					<form method="post" enctype="multipart/form-data" action="updateaction/update_blog_mcat.php">
						<fieldset>
						...
						<fieldset><br>
							<div class="form-group row"> <label class="col-md-12 col-form-label" for="input-id-1">Category Feature Image (Min Size: 1920 x 1000)</label>
								...
								<div class="col-md-4">
									<a href="javascript: void(0)" onclick="popup('../images/Category/Covers/<?php echo $row22['mcat_cover']; ?>')"><img src="../images/Category/Covers/<?php echo $row22['mcat_cover']; ?>" width="250" height="200" /></a>
								</div>
							</div>
						</fieldset>
